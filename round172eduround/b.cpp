...
void Vedant(){
    ...
    // m.size() - 2 basically means he will atleast have one marbel of each colour
    // except cnt/2 bcz those 1 freq ones will be acquired by bob
    cout << (cnt + 1)/2 + (m.size() - cnt/2) << endl;
}
